...
public class frm_Dashboard extends javax.swing.JFrame {
    ...
    private void setColor(JPanel pane) {
        pane.setBackground(new Color(51,153,255));
    }

    private void resetColor(JPanel[] pane, JPanel[] indicators) {
        for (int i = 0; i < pane.length; i++) {
            pane[i].setBackground(new Color(51,153,255));
    ...
    private void initComponents() {
        ...
        btnbanhang.setBackground(new java.awt.Color(51, 153, 255));
        ...
        btnkhuyenmai.setBackground(new java.awt.Color(51, 153, 255));
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/coupon.png"))); // NOI18N
        ...
        btndangxuat.setBackground(new java.awt.Color(51, 153, 255));
