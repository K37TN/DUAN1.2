...
public class ChiTietSPServices implements IChiTietSPServices {
    ...
    public boolean Add(ChiTietSPViewModel x) {
        ...
        ChiTietSP ctsp = new ChiTietSP(x.getMa(), x.getTen(), x.getNsx().getId(), x.getMausac().getId(), x.getDanhmuc().getId(), x.getKichco().getId(), x.getChatlieu().getId(), x.getThuonghieu().getId(),1, x.getSoluongton(), x.getGianhap(), x.getGiaban(), x.getMota());
        try {
    ...
    public boolean Update(String ma, ChiTietSPViewModel x) {
        ChiTietSP ctsp = new ChiTietSP(x.getMa(), x.getTen(), x.getNsx().getId(), x.getMausac().getId(), x.getDanhmuc().getId(), x.getKichco().getId(), x.getChatlieu().getId(), x.getThuonghieu().getId(),0, x.getSoluongton(), x.getGianhap(), x.getGiaban(), x.getMota());
